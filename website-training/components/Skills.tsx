    ...
    <div className={''}> 
       <div>
         ...
         <a  href='https://bootcamperknowledge.herokuapp.com/'>
          <img className={styles.images} src="https://videoapi-muybridge.vimeocdn.com/animated-thumbnails/image/8f923854-1c63-4bf1-ac71-4cdd10fda6ed.gif?ClientID=vimeo-core-prod&Date=1645557355&Signature=d0deab5ff1f4fe70ef7b3c0bad7537b877dd2261" alt=''/>
         </a>
         <div className={styles.header_one}>
          <h2>Description<br/><p>This is the result of our national project week.
            ...
            <p><span>Tools : </span>Html,Css,Vanilla Javascript, React, Express, Heroku, Miro Board, Figma, Wireframe</p>
        ...
        <a className={styles.images} href='https://weather-application001.herokuapp.com/'>
          ...
          <h2>Description<br/><p>First Project of School of Code where i create a City Info using e weather API.
            ...
            <p><span>Tools : </span>Html,Css,Vanilla Javascript, FetchAPI</p>
       ...
       <div>
        ...
        <div className={styles.header_one}>
          <h2>Description<br/><p>With this exercise i start to watch around for simple template for create portfolio on the internet.<br/>
            ...
            <p><span>Tools : </span>Html,Bootstrap tools, Netlify</p>
